...
| --- | --- | --- |
| Build from scratch | Création de formulaires (UI button) Créer un formulaire à partir de zéro (in text) |  |
| DATA page | page DONNÉES |  |
| Downloads page | page Téléchargements |  |
| Draft | Brouillon | French: not “ébauche” |
| Embeddable Web Form Code | Code de formulaire Web |  |
| FORM page | page FORMULAIRE |  |
