...
| FORM page | page FORMULAIRE | página FORMULARIO |  |
| FORM tab | onglet FORMULAIRE | Ventana FORMULARIO |  |
...
# KoboCollect Terminology (PREFERRED)
...
| Add | Ajouter | Agregar |
| Automatic location recording | Enregistrement automatique de la localisation | Registro de localización automática |
