...
Cet article fournit un guide rapide pour commencer à utiliser KoboToolbox. Il explique comment créer un compte, construire et déployer un formulaire, et commencer à collecter des données.
...
Pour plus d'informations sur la gestion de vos données, consultez la section d'aide sur la gestion de projets et de données.