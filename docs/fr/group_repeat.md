...
Grouper des questions permet d'organiser des questions connexes en sections, d'ajouter de la structure à votre formulaire et de faciliter la navigation. Par exemple, toutes les questions démographiques peuvent être regroupées dans une seule section du formulaire.
...
2. Sélectionnez les questions à l'aide de la touche **CTRL** (Windows) ou de la touche **Command** (Mac).
3. Appuyez sur <i class="k-icon-group"></i> **Créer un groupe avec les questions sélectionnées** dans la barre de menu en haut à gauche.
...
<p class="note">
    <b>Remarque :</b> Vous pouvez également créer une seule question, sélectionner la question et appuyer sur <b>Créer un groupe</b>. Ensuite, vous pouvez ajouter d'autres questions dans le groupe, comme indiqué ci-dessous.
</p>

### Ajouter des questions dans un groupe

Passez votre souris n'importe où à l'intérieur du groupe où vous souhaitez ajouter une nouvelle question. Appuyez sur le <i class="k-icon-plus"></i> **signe** à l'intérieur du groupe pour ajouter une nouvelle question.

<p class="note">
    <b>Remarque :</b> Si vous appuyez sur le <i class="k-icon-plus"> </i><b>signe</b> situé à l'extérieur du groupe, vous ajouterez une question en dehors du groupe.
</p>

Vous pouvez également faire glisser et déposer n'importe quelle question existante dans un groupe de questions.

### Supprimer des questions d'un groupe

Pour supprimer une question d'un groupe tout en la conservant dans le formulaire, sélectionnez la question et faites-la glisser en dehors du groupe.

Pour supprimer définitivement une question du formulaire, appuyez sur <i class="k-icon-trash"></i> **Supprimer la question** dans le menu de la question à droite, puis appuyez sur **OK**.
...
Si vous n'avez plus besoin d'un groupe de questions, vous pouvez soit les dégrouper, soit supprimer l'ensemble du groupe. Pour ce faire, appuyez sur le bouton <i class="k-icon-trash"></i> **Supprimer** dans l'en-tête du groupe.

Une boîte de dialogue apparaîtra vous demandant de confirmer si vous souhaitez diviser le groupe ou tout supprimer.

- Appuyez sur **DÉGROUPER** pour supprimer le groupe tout en conservant les questions dans le formulaire.
- Appuyez sur **TOUT SUPPRIMER** pour supprimer à la fois le groupe et toutes ses questions.
...
Pour afficher les questions par groupe sur le même écran lors de la collecte de données, appuyez sur l'icône <i class="k-icon-settings"></i> **Paramètres** à droite du nom du groupe. Ensuite, sous **Apparence (Avancée)**, sélectionnez **field-list** (Afficher toutes les questions de ce groupe sur le même écran).
...
Pour ignorer un groupe de questions, assurez-vous d'avoir au moins une question de contrôle positionnée avant les questions groupées. Appuyez sur l'icône <i class="k-icon-settings"></i> **Paramètres** pour la question groupée, puis sélectionnez **Logique de saut** et configurez les conditions de logique de saut comme vous le feriez pour une question individuelle.
