...
<br><br>
Pour une pratique concrète des apparences de questions dans XLSForm, consultez le <a href="https://academy.kobotoolbox.org/courses/xlsform-fundamentals">Cours sur les fondamentaux XLSForm</a> de KoboToolbox Academy.
</p>
...
| `map` | Affiche une carte pour sélectionner les options. Nécessite de <a href="https://support.kobotoolbox.org/select_from_map_xls.html">définir les coordonnées GPS</a> dans la feuille `choices` (`select_one` uniquement). | KoboCollect uniquement |
| `quick map` | Affiche une carte pour sélectionner les options, en enregistrant automatiquement le premier emplacement sélectionné sans afficher d'informations supplémentaires. Nécessite de <a href="https://support.kobotoolbox.org/select_from_map_xls.html">définir les coordonnées GPS</a> dans la feuille `choices` (`select_one` uniquement). | KoboCollect uniquement |

<p class="note">
  <b>Remarque :</b> Les apparences pour les questions <code>select_one</code> et <code>select_multiple</code> peuvent également être utilisées pour les questions <a href="https://support.kobotoolbox.org/select_from_file_xls.html">select from file</a>.
</p>
...
| `picker` | Dans KoboCollect, affiche un sélecteur rotatif contextuel pour sélectionner les valeurs. Dans Enketo, affiche un menu déroulant. | Enketo et KoboCollect |
...
| Apparence | Description | Compatibilité |
| :--- | :--- | :--- |
| `maps` | Affiche une carte permettant aux utilisatrices et utilisateurs de visualiser l'emplacement qui est enregistré automatiquement (`geopoint` uniquement). | KoboCollect uniquement (inclus dans l'apparence Enketo par défaut)  |
...
| `draw` | Permet aux utilisatrices et utilisateurs d'esquisser ou de créer des dessins. | Enketo et KoboCollect |
