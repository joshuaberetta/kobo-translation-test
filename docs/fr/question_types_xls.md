...
| `acknowledge` | Une case à cocher unique que les répondant(e)s peuvent sélectionner pour reconnaître leur accord avec une déclaration. | Consentement |
...
Les questions de date et d'heure sont utilisées pour capturer des dates calendaires spécifiques, des heures ou les deux dans une seule réponse.

| Type XLSForm | Description | Équivalent dans l'interface de création de formulaires |
| :--- | :--- | :--- |
| `date` | Capture une date calendaire spécifique, généralement au format jour, mois et année. | Date |
...
<p class="note">
Pour en savoir plus sur les questions de date et d'heure dans KoboToolbox, consultez <a href="https://support.kobotoolbox.org/date_time.html">Types de questions Date et Heure</a>.
</p>
