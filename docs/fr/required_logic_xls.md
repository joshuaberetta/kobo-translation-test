...
Cet article explique comment ajouter des conditions de logique de réponse obligatoire dans XLSForm, y compris rendre une question obligatoire en fonction de la réponse à une autre question.
...
## Ajouter une logique de réponse obligatoire basée sur le fait qu'une question a été répondue
