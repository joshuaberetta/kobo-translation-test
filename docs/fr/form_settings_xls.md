...
| <code>version</code>        | Inclut une chaîne de caractères qui représente la version actuelle de l'XLSForm (par exemple, v1 ou AAAAMMJJ). Utile pour suivre les versions de formulaire lors de la collaboration. |
