...
Enketo, se muestra un selector de hora donde los/as usuarios/as pueden
...
Para agregar preguntas de "Fecha", "Hora" y "Fecha y hora" en XLSForm, utiliza los
...
Al agregar el tipo de pregunta "Fecha" en el editor de formularios, puedes elegir entre varias
opciones de visualización (en la configuración de la pregunta). Las apariencias cambian la
...
eligiendo entre las opciones "month-year", "year" y "no-calendar".
...
Para agregar valores de apariencia que no están en la lista desplegable del
editor de formularios, elige "other" y escribe el valor de apariencia en el campo de texto
que aparece.
...
Puedes especificar apariencias avanzadas en XLSForm a través de la columna appearance de la
siguiente manera:

#### Apariencias del selector de fechas
...
Al definir lógica de omisión personalizada (relevant), criterios de validación (constraint)
y criterios de respuesta obligatoria (required) usando código XLSForm, los valores de fecha deben incluirse
...
Para usar preguntas de "Hora" en lógica XLSForm, siempre es buena idea convertir
...
si deseas limitar la hora ingresada en una pregunta solo después de las 12 del mediodía,
