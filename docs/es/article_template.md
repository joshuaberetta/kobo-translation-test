...
Aquí es donde va tu introducción. Ten en cuenta que el código "Última actualización" que aparece arriba se actualizará automáticamente con el nombre del artículo y la fecha correctos cuando publiques, por lo que no es necesario ningún cambio manual. Recuerda nombrar este archivo según el título del artículo y terminar el nombre del archivo con `.md`.

Este artículo incluye:

-   [Dar formato al texto en markdown](#este-es-un-encabezado)
-   [Agregar archivos multimedia](#agregar-archivos-multimedia)
-   [Agregar tablas](#agregar-tablas)
-   [Formato HTML](#formato-html)
-   [Crear una sección de solución de problemas](#solución-de-problemas)
...
Insertar enlaces: Para transferir la propiedad de tu equipo a otro/a usuario/a, [comunícate con nuestro equipo de soporte](support@kobotoolbox.org).
...
![imagen](/images/getting_started_organization_feature/organizations_project_views.gif)

Almacena las imágenes en la [carpeta de imágenes](https://github.com/kobotoolbox/docs/tree/master/source/images), en una carpeta con el nombre del artículo de ayuda. Incluye el nombre de la carpeta y el nombre del archivo de imagen en la ruta del archivo anterior.

### Agregar iconos
Haz clic en el icono <i class="k-icon k-icon-more"></i> **Más acciones** para el/la usuario/a que deseas eliminar.
...
<iframe src="https://www.youtube.com/embed/oKtMmBAlHho?si=OqS7-rewYMf-Rrw2" style="width: 100%; aspect-ratio: 16 / 9; height: auto; border: 0;" title="Reproductor de video de YouTube" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
| parameters         | Configuración para tipos de preguntas específicas           |
...
Nota el `| survey |` en la parte inferior de la tabla.
...
<br>
    Usa este formato para configurar <strong>secciones de solución de problemas</strong> en tus artículos de ayuda. Incluye un título breve que describa claramente el problema y propón soluciones aquí.
    <br><br>
    Para separar líneas dentro de un elemento de solución de problemas, agrega un salto de línea doble.
</details>
...
<details>
<summary><strong>Gestión de proyectos</strong></summary>
<br>
