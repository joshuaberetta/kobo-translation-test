...
<p class="note">
  Para obtener más información sobre las preguntas obligatorias y cómo personalizar el mensaje que se muestra a los/as encuestados/as cuando dejan una pregunta obligatoria sin responder, consulta <a href="https://support.kobotoolbox.org/es/question_options_xls.html#required-questions">Opciones de preguntas en XLSForm</a>.
</p>
...
| date | `${pregunta_de_referencia}` seguido de un operador lógico (>, <, =) y `date('AAAA-MM-DD')` | `${dob} >= date('1975-01-01')` |
...
Además de configurar lógica de obligación para una respuesta específica, también puedes basarla en si una pregunta fue respondida o dejada en blanco. Esto es útil cuando deseas asegurarte de que al menos una de dos preguntas sea obligatoria.
