...
| :----------------- | :--------------------------------------------- |
| XLS               | Archivo de Microsoft Excel (formato .xlsx). Este tipo de archivo es recomendado cuando recolectas datos de grupos de repetición.                                  |
...
| GeoJSON           | Este es un formato estándar abierto de intercambio de datos geoespaciales, ideal para integrar con software GIS como ArcGIS.            |
...
| Media Attachments (ZIP)               |  Descarga un archivo ZIP que contiene todos los archivos multimedia recolectados a través del formulario.                               |
...
Cuando usas los formatos de exportación estándar (XLS, CSV, GeoJSON y SPSS Labels), puedes seleccionar el formato de los valores de tus datos y encabezados:
...
- Reintenta la exportación haciendo click en el botón <strong>EXPORTAR</strong> nuevamente.
...
<details>
    <summary><strong>Datos de grupo de repetición no encontrados</strong></summary>
Solo el <b>formato XLS</b> soporta datos de grupos de repetición. Cada grupo de repetición será exportado <strong>como una hoja separada</strong> en el archivo exportado. Las descargas CSV solo proporcionarán los datos principales, sin datos de grupos de repetición. 
<br><br>
