...
Para acceder a la barra lateral de La biblioteca de preguntas, haz click en el botón **Agregar desde la biblioteca** en la esquina superior derecha de la barra de herramientas del editor de formularios.
...
Para agregar la pregunta a tu formulario, **arrástrala y suéltala** en la posición deseada. Una pregunta se puede agregar varias veces si es necesario, por ejemplo, cuando se reutiliza una escala específica para diferentes preguntas.
...
También puedes **agregar nuevas preguntas** desde dentro de la biblioteca. Simplemente haz click en **Nuevo** y podrás crear una nueva pregunta que se guardará en la biblioteca.
...
* (Opcional) Define cualquier etiqueta para la pregunta o bloque agregando una columna **tag:[nombre de tu etiqueta]** para cada etiqueta, luego escribe '1' en cada fila que deba usar la etiqueta. En el caso de los bloques, es suficiente escribir '1' en cualquiera de las filas del bloque sin importar cuál. Es suficiente marcar una de las preguntas en el bloque, aunque no importa si se etiquetan varias preguntas.
...
* Puedes incluir lógica de omisión y reglas de validación dentro de los bloques que importes. Eso es muy útil cuando se importan bloques completos de preguntas en nuevos borradores de formularios sin tener que reconstruir estas configuraciones avanzadas.
