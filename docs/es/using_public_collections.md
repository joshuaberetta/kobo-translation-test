# Uso de Colecciones Públicas

Obtener la información correcta a menudo depende de hacer las preguntas correctas.
**Las Colecciones Públicas** nos ayudan a todas las personas a mejorar nuestra recolección de datos al hacer que conjuntos
de preguntas de encuesta predefinidas sean públicos y fácilmente accesibles para toda la comunidad de Kobo. Cualquier persona puede crear, encontrar y usar estas colecciones libremente, permitiendo
a los equipos y organizaciones estandarizar sus encuestas, así como permitiéndoles
contribuir al trabajo y mejores prácticas de otras personas. Estas colecciones pueden
...
Los/as usuarios/as pueden elegir hacer públicas sus preguntas de encuesta, lo que significa que se
incluirán en la biblioteca de **Colecciones Públicas**. Todos/as los/as usuarios/as en la
[misma instancia de servidor](creating_account.md) tendrán acceso a las mismas **Colecciones
Públicas**, que pueden incluir preguntas comunes o grupos de preguntas, tales
como características demográficas, DHS (Vigilancia Demográfica y de Salud), herramienta de equidad
para determinación de riqueza, así como otras medidas estándar ampliamente utilizadas.

## Ubicación de las Colecciones Públicas
...
-   Usa la barra de búsqueda y escribe palabras clave relevantes (ver a continuación). Puedes aprender
...
Además, clonar las preguntas te permite agregarlas a tu biblioteca personal.
Luego puedes
...
### c) Creación de una Colección Pública
...
Una vez que se haya creado la colección, verás las siguientes opciones:
