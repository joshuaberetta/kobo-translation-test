...
La siguiente tabla proporciona un resumen de alto nivel de cada uno de los tipos de respuesta disponibles para usar en tu XLSForm y en el Formbuilder:

| Tipo de pregunta                 | Icono                                         | Entrada de respuesta                                                                                    |
| :------------------------------- | :-------------------------------------------- | :------------------------------------------------------------------------------------------------------ |
...
| range                            | <i class="k-icon k-icon-qt-range"></i>        | Entrada de rango (incluye calificación).                                                                |
| text                             | <i class="k-icon k-icon-qt-text"></i>         | Respuesta de texto libre.                                                                               |
| select_one [options]             | <i class="k-icon k-icon-qt-select-one"></i>   | Pregunta de selección múltiple; solo se puede seleccionar una respuesta.                                |
| select_multiple [options]        | <i class="k-icon k-icon-qt-select-many"></i>  | Pregunta de selección múltiple; se pueden seleccionar varias respuestas.                                |
| select_one_from_file [file]      | <i class="k-icon k-icon-qt-select-one"></i>   | Selección múltiple desde archivo; solo se puede seleccionar una respuesta.                              |
| select_multiple_from_file [file] | <i class="k-icon k-icon-qt-select-many"></i>  | Selección múltiple desde archivo; se pueden seleccionar varias respuestas.                              |
| rank [options]                   | n/a                                           | Pregunta de clasificación; ordenar una lista.                                                           |
| note                             | <i class="k-icon k-icon-qt-note"></i>         | Mostrar una nota en la pantalla, no requiere entrada. Forma abreviada de type=text con readonly=true.  |
...
| calculate                        | <i class="k-icon k-icon-qt-calculate"></i>    | Realizar un cálculo; ver la sección de Cálculo a continuación.                                          |
| acknowledge                      | <i class="k-icon k-icon-qt-acknowledge"></i>  | Solicitud de confirmación que establece el valor en "OK" si se selecciona.                              |
| hidden                           | <i class="k-icon k-icon-qt-hidden"></i>       | Un campo sin elemento de interfaz de usuario/a asociado que se puede usar para almacenar una constante. |
...
| Tipo de pregunta del Formbuilder | Icono                                            | Entrada de respuesta                                                      |
| :------------------------------- | :----------------------------------------------- | :------------------------------------------------------------------------ |
| Calificación                     | <i class="k-icon k-icon-qt-rating"></i>          | Comparar diferentes elementos usando una escala común.                    |
| Clasificación                    | <i class="k-icon k-icon-qt-ranking"></i>         | Comparar una lista de diferentes objetos entre sí.                        |
| Matriz de preguntas              | <i class="k-icon k-icon-qt-question-matrix"></i> | Crear un grupo de preguntas que se muestran en formato de matriz.        |
