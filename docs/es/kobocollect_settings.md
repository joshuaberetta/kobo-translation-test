...
- Manejar cómo se gestionan los formularios (por ejemplo, envío automático, finalización, reglas de edición)
...
Los ajustes de la interfaz de usuario/a te permiten ajustar la apariencia, el idioma y el tamaño del texto de la aplicación para mejorar la legibilidad.
...
Los ajustes de manejo de formularios controlan cómo se gestionan los formularios dentro de la aplicación, incluyendo actualizaciones de versiones de formularios, envíos y comportamientos de entrada de datos. 

| **Ajuste** | **Descripción**                  |
| :----------------- | :--------------------------------------------- |
| Modo de actualización de formulario en blanco &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;              | Define si deseas que las nuevas versiones de los formularios se actualicen automática o manualmente. Las opciones incluyen: <ul><li><strong>Manual</strong>: El modo predeterminado, en el cual los/as encuestadores/as manejan manualmente la actualización de formularios.</li><li><strong>Solo formularios descargados previamente</strong>: Los/as encuestadores/as reciben una notificación cuando uno o más formularios descargados previamente al dispositivo tienen una actualización disponible.</li><li><strong>Coincidir exactamente con el servidor</strong>: Todos los formularios compartidos con la cuenta se descargan y actualizan automáticamente según los cambios en el servidor.</li></ul> |
...
| Recolectar datos de uso anónimos      | Permite que el equipo de KoboToolbox recolecte datos de uso anónimos para ayudarnos a priorizar correcciones y funcionalidades. |

## Establecer contraseña de administrador/a

Establece una contraseña de administrador/a en la aplicación KoboCollect, limitando el acceso al menú de ajustes **Protegidos** solo a los/as miembros del equipo con la contraseña de administrador/a. Esto puede ayudar a prevenir que los/as recolectores/as de datos modifiquen los ajustes en el campo.
...
Los ajustes de manejo de proyectos proporcionan herramientas para manejar y restablecer los ajustes relacionados con el proyecto en tu dispositivo, incluyendo reconfigurar ajustes, restablecer datos específicos o eliminar todos los datos del proyecto.
